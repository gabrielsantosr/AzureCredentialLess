# AzureCredentialLess
Explorative project to demonstrate the possibility to query data stored Microsoft Dynamics CRM in a tenant from an Function App in another tenant without using passwords, nor secrets, nor certificates.
